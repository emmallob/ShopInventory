...
if(isset($SITEURL[1]) and preg_match("/^[a-z0-9-]+$/",strtolower($SITEURL[1])) and $customers->_list_customer_by_id(strtoupper($SITEURL[1]))->cus_found):
...
<input name="customer_id" readonly required value="<?php print $SITEURL[1]; ?>" type="text" class="span8 form-control" id="customer_id">
</div>
</div>
</div>
...
<input name="firstname" required value="<?php print $customers->_list_customer_by_id($SITEURL[1])->c_firstname; ?>" type="text" class="span8 form-control" id="firstname">
</div>
</div>
<div class="col-sm-6">
...
<input name="lastname" required  value="<?php print $customers->_list_customer_by_id($SITEURL[1])->c_lastname; ?>" type="text" class="span8 form-control" id="lastname">
</div>
</div>
</div>
...
<option value="<?php print $customers->_list_customer_by_id($SITEURL[1])->c_gender; ?>">Select Gender</option>
<option <?php if($customers->_list_customer_by_id($SITEURL[1])->c_gender == "MALE") print "selected"; ?> value="MALE">MALE</option>
<option <?php if($customers->_list_customer_by_id($SITEURL[1])->c_gender == "FEMALE") print "selected"; ?> value="FEMALE">FEMALE</option>
</select>
</div>
</div>
<div class="col-sm-6">
...
<select class="form-control" id="selectError" name="region" data-rel="chosen">
	...
	?>
	<?php if($customers->_list_customer_by_id($SITEURL[1])->c_region==$shop_results["id"]): ?>
...
<input maxlength="15" name="contact" value="<?php print $customers->_list_customer_by_id($SITEURL[1])->c_contact; ?>" type="text" class="form-control" id="contact">
</div>
</div>
<div class="col-sm-6">
...
<input maxlength="15" name="contact2" value="<?php print $customers->_list_customer_by_id($SITEURL[1])->c_contact2; ?>" type="text" class="span8 form-control" id="contact2">
</div>
</div>
</div>
...
<input maxlength="100" name="email" value="<?php print $customers->_list_customer_by_id($SITEURL[1])->c_email; ?>" type="email" class="form-control" id="email">
</div>
</div>
<div class="col-sm-6">
...
<input maxlength="100" name="website" value="<?php print $customers->_list_customer_by_id($SITEURL[1])->c_website; ?>" type="text" class="span8 form-control" id="website">
</div>
</div>
</div>
...
<input maxlength="15" name="balance" value="<?php print $customers->_list_customer_by_id($SITEURL[1])->c_balance; ?>" type="text" class="form-control autonumber" id="balance">
</div>
</div>
<div class="col-sm-6">
...
<input maxlength="15" name="outstanding" value="<?php print $customers->_list_customer_by_id($SITEURL[1])->c_outstanding; ?>" type="text" class="span8 form-control autonumber" id="outstanding">
</div>
</div>
</div>
...
<textarea class="form-control" onclick="return hidepassfield();" id="address" name="address" rows="6"><?php print $customers->_list_customer_by_id($SITEURL[1])->c_address; ?></textarea>
</div>
</div>
</div>
...
<input type="hidden" name="customerEdit">
