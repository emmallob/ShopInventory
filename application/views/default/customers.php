...
<span>This page displays all customers that have currently been added unto the server.</span>
</div><br clear="both">
<div class="col-sm-12">
<?php 
...
<?php 
#
$list_customers = $DB->query("select * from _customers where store_id='".STORE_ID."' order by id desc limit 5");
foreach($list_customers as $results):
?>
<tr>
<td><?php print $results["id"]; ?></td>
<td><?php print strtoupper($results["firstname"] ." " .$results["lastname"]); ?></td>
...
<td>
<button title="View / Edit Customer details" onclick="window.location.href='<?php print SITE_URL; ?>/customers-view/<?php print $results["customer_id"]; ?>'" type="button" class="btn btn-info"><i class="ion-eye"></i></button>
</td>
</tr>
<?php endforeach; ?>
</tbody>
