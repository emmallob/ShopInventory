...
<span>This page displays the list of products that has been purchased by clients on credit.</span>
</div>
...
$list_orders = $DB->query("select * from _customers_orders where $where_clause and payment_complete='0' and store_id='".STORE_ID."'");
#list them here 
...
<td><span class="font-medium">GH¢ <?php print number_format($results["overall_price"], 2); ?></span></td>
<td><span class="font-medium">GH¢ <?php print number_format(($results["overall_price"] - $results["total_paid"]), 2); ?></span></td>
