...
$config['sess_save_path'] = "/inventory/application/sessions/";
...
$config['developer'] = 'Emmanuel Obeng (emmallob14@gmail.com)';
$config['update_folder'] = '/inventory/application/backups/';